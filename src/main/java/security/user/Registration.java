...
public class Registration {
    ...
    public User registerStandardUser(@NonNull String username, @NonNull String password) throws IOException {
        validateNullMember();
    ...
    public User registerAdminUser(@NonNull String username, @NonNull String password) throws IOException {
        return new Administrator(username, password);
    }

    public User registerAgentUser(@NonNull String username, @NonNull String password) throws IOException {
