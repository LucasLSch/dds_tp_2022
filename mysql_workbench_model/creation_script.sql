...
-- -----------------------------------------------------
-- Table `grupo7`.`base_unit`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `grupo7`.`base_unit` ;

CREATE TABLE IF NOT EXISTS `grupo7`.`base_unit` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `description` VARCHAR(15) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;

CREATE UNIQUE INDEX `id_UNIQUE` ON `grupo7`.`base_unit` (`id` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `grupo7`.`simple_unit` (
  ...
  CONSTRAINT `simple_unit_emission_factor_fk`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `simple_unit_base_unit_fk`
    FOREIGN KEY (`base_unit_id`)
    REFERENCES `grupo7`.`base_unit` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `simple_unit_base_unit_fk_idx` ON `grupo7`.`simple_unit` (`base_unit_id` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `grupo7`.`public_transport` (
  ...
  `line_id` INT NOT NULL,
  `fuel_consumption_per_km` FLOAT NOT NULL,
  PRIMARY KEY (`id`),
